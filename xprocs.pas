...
begin
  if IsWin95 or IsWinNT then
    Result:=MsgBox({$IFDEF VER100}SMsgDlgConfirm{$ELSE}LoadStr(SMsgdlgConfirm){$ENDIF},
...
begin
  if IsWin95 or IsWinNT then
     MsgBox({$IFDEF VER100}SMsgdlgInformation{$ELSE}LoadStr(SMsgdlgInformation){$ENDIF},
...
begin
  if IsWin95 or IsWinNT then
     case MsgBox({$IFDEF VER100}SMsgDlgConfirm{$ELSE}LoadStr(SMsgDlgConfirm){$ENDIF},
